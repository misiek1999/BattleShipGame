...
namespace GameSession {
    ...
    public:
        ...
        bool registerPlayer(const PlayerType player,
                            std::shared_ptr<Player::IPlayerCallbacks> player_callback) {
            if (!player_callback) {
        ...
        bool unregisterPlayer(const PlayerType player) {
        ...
        RequestId getBoard(const PlayerType player) {
        ...
        RequestId getOponentBoard(const PlayerType player) {
        ...
        RequestId getPlayerShipsCount(const PlayerType player) {
        ...
        RequestId getScore(const PlayerType player) {
        ...
        RequestId getPlayerTurn(const PlayerType player) {
        ...
        RequestId getGameStatus(const PlayerType player) {
        ...
        RequestId notifyPlayerReadyForNextRound(const PlayerType player) {
        ...
        RequestId notifyPlayerDisconnected(const PlayerType player) {
